...
class Product {
  final int id;
  final String title, description, brandName;
...
// Updated demo Products with brand names
List<Product> demoProducts = [
  Product(
    ...
    images: [
      ...
      "assets/images/predator/predator4.png",
      "assets/images/predator/predator5.png",
      "assets/images/predator/predator6.png",
      "assets/images/predator/predator7.png",
      "assets/images/predator/predator8.png",
    ],
    colors: [
